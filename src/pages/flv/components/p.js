...
},{"base64-js":"prL8","ieee754":"iism","isarray":"BOve","buffer":"XyCw"}],"SLEA":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"eventemitter3":"JJlS","inherits":"Bm0n"}],"f7mc":[function(require,module,exports) {
...
function (_EventEmitter) {
  ...
  var _super = _createSuper(BrowserSound);
...
exports.default = _default;
},{"buffer":"XyCw","eventemitter3":"JJlS"}],"RrKo":[function(require,module,exports) {
"use strict";
...
function (_BrowserSound) {
  ...
  var _super = _createSuper(WeChatSound);
...
exports.default = _default;
},{"./browser":"f7mc"}],"Howj":[function(require,module,exports) {
"use strict";
...
var _default = Sound;
exports.default = _default;
},{"../util/util":"ACyo","./browser":"f7mc","./wechat":"RrKo"}],"ILxu":[function(require,module,exports) {
    ...
    value: function _onTickHandler() {
      ...
      if (this.hasAudio && this.hasVideo) {
        ...
        for (var i = 0; i < this.frames.length; i++) {
          var _timestamp = this.frames[i].timestamp;

          var _diff2 = this.currentTime - _timestamp;

          if (Math.abs(_diff2) <= 25) {
        ...
        case 'audio':
          {
            var _msg$data3 = msg.data,
                _timestamp2 = _msg$data3.timestamp,
                _buffer = _msg$data3.buffer;

            if (!this.baseTime) {
              this.baseTime = _timestamp2;
            }
        ...
        case 'decode':
          {
            ...
            this.state = 'playing';
            this.ticker.setFps(this.framerate);
            var _msg$data4 = msg.data,
                consume = _msg$data4.consume,
                duration = _msg$data4.duration;
...
exports.default = _default;
},{"buffer":"XyCw","eventemitter3":"JJlS","../util/ticker":"SLEA","../sound/sound":"Howj","../util/util":"ACyo"}],"Monm":[function(require,module,exports) {
"use strict";
...
function _default() {
  ...
  function slice(buffer, startIndex, endIndex) {
    ...
    if (supportSharedBuffer) {
      var sharedBuffer = new SharedArrayBuffer(endIndex - startIndex);
      var result = new Uint8Array(sharedBuffer);
...
function (_EventEmitter) {
  ...
  var _super = _createSuper(ChunkLoader);
...
exports.default = _default;
},{"buffer":"XyCw","eventemitter3":"JJlS"}],"TytF":[function(require,module,exports) {
"use strict";
...
var _default = Loader;
exports.default = _default;
},{"./stream":"Monm","./chunk":"DaV8","../util/util":"ACyo"}],"VXbF":[function(require,module,exports) {
"use strict";
...
function () {
  ...
  _createClass(Drawer, [{
    ...
    value: function drawNextOutputPicture(width, height, data) {
      ...
      var cbDataLength = width * height / 4;
...
function (_EventEmitter) {
  ...
  var _super = _createSuper(WXInlinePlayer);
  ...
  _createClass(WXInlinePlayer, [{
    ...
    value: function _initlize() {
      ...
      this.processor.on('performance', function (data) {
        return _this2.emit('performance', data);
      });
    ...
    value: function _onMediaInfoHandler(mediaInfo) {
      var _mediaInfo$onMetaData = mediaInfo.onMetaData,
          onMetaData = _mediaInfo$onMetaData === void 0 ? [] : _mediaInfo$onMetaData;
...
exports.default = _default;
},{"eventemitter3":"JJlS","./processor/processor":"ILxu","./loader/loader":"TytF","./drawer/drawer":"VXbF","./util/util":"ACyo"}]},{},["Focm"], null)